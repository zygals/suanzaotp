...
http://59.110.40.141/pma_9959dbbf/
suanzao
z13751025707
...
alter table article add tp tinyint not null default 1 comment '类型 1资讯 2案例';
alter table cate add tp tinyint not null default 1 comment '分类类型 1资讯 2案例';
酸枣
