<div class="header">
    <div class="headbox clearfix">
        ...
        <ul>
            ...
            <li><a href="{:url('product/anli')}">直播案例</a></li>
            <li><a href="{:url('product/houtai')}">直播间后台</a></li>
            ...
            <li><a href="{:url('anli/index')}" style="<?php if(request()->controller()=='Anli'){?>color:rgb(32,112,251);<?php }?>">最新动态</a></li>
