...
{block name="title"}seo优化列表{/block}
{block name="content"}
<style>
...
<div role="tabpanel" class="tab-pane" id="user" style="display:block;">
	<div class="check-div form-inline row">
				<div class="col-xs-2">
                    <a href="{:url('create')}"><button class="btn btn-yellow btn-xs" id="create">添加seo优化</button></a>
		</div>
		<div class="col-xs-10">
	...
	<div class="data-div">
		...
		<div class="tablebody">
			...
			<div class="row cont_nowrap">
                ...
                <div class="col-xs-2 " title="{$row_->nav_id}">
                    {$row_->nav_id}
                </div>
                <div class="col-xs-1" title="{$row_->nav_id}">
                    {$row_->title}
                </div>
                <div class="col-xs-2 " title="{$row_->nav_id}">
                    {$row_->keywords}
