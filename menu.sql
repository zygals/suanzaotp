...
CREATE TABLE `menu_admin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 COMMENT='后台左侧导航';
...
INSERT INTO `menu_admin` VALUES (19,'主要管理',0,'','','',0,1505358580,1505358580),(20,'资讯/案例',19,'Article','index','',0,1505358628,1506490666),(22,'广告图',19,'Ad','index','',1,1505358704,1505970654),(23,'其它管理',0,'','','',1,1505358751,1505358751),(30,'文件下载',19,'Dfile','index','',2,1505970647,1505970647),(26,'类别',23,'Cate','index','',0,1505369468,1505970973),(32,'管理员',23,'Admin','index','',0,1507605548,1507605548),(31,'友情链接',23,'Friend','index','',0,1507601734,1507601734),(29,'SEO设置',23,'SeoSet','index','',4,1505699413,1505699516);
...
-- Dump completed on 2017-10-11 10:24:24
